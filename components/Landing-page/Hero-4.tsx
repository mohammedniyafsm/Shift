...
export function Hero4() {
    return (
        <div className="bg-[rgb(249,250,249)] mt-12 py-12">
            ...
            <div className="">
                <h1 className="py-8 flex justify-end px-12 lg:text-3xl lg:flex lg:justify-center lg:ml-12">Secure and private</h1>
                <div className="">
                    <h1 className="font-medium text-5xl pl-12 pr-8 lg:text-[180px] lg:px-28 ">The Secure way to Web3</h1>
                </div>
            </div>
